...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}body{margin:0;background:radial-gradient(1100px 600px at 90% -10%,#243c5c 0,#10151f 44%,var(--bg) 75%);color:var(--text);font:15px/1.55 Inter,ui-sans-serif,system-ui,-apple-system,Segoe UI,sans-serif}button,input,textarea,select{font:inherit}button{cursor:pointer}a{color:var(--accent2)}
    .shell{max-width:1180px;margin:0 auto;padding:30px 20px 70px}.top{display:flex;justify-content:space-between;align-items:center;gap:20px;margin-bottom:28px}.brand{display:flex;align-items:center;gap:13px}.mark{display:grid;place-items:center;width:40px;height:40px;border:1px solid #b9f36a88;border-radius:13px;background:linear-gradient(145deg,#b9f36a33,#79d7ff1f);font-weight:800;color:var(--accent)}h1,h2,h3,p{margin-top:0}.brand h1{font-size:20px;letter-spacing:.02em;margin-bottom:1px}.eyebrow{font-size:11px;text-transform:uppercase;letter-spacing:.16em;color:var(--muted)}.top-note{color:var(--muted);font-size:13px;text-align:right}.hero{max-width:800px;margin-bottom:28px}.hero h2{font-size:clamp(29px,4vw,50px);line-height:1.03;letter-spacing:-.04em;margin:0 0 13px}.hero p{color:var(--muted);font-size:17px;max-width:720px}.grid{display:grid;grid-template-columns:minmax(0,1.08fr) minmax(330px,.92fr);gap:18px;align-items:start}.panel{background:linear-gradient(160deg,#171d2aee,#10151eee);border:1px solid var(--line);border-radius:22px;box-shadow:var(--shadow);padding:22px}.panel h3{font-size:17px;margin-bottom:5px}.sub{color:var(--muted);font-size:13px;margin-bottom:18px}.field{margin-bottom:15px}.field label{display:flex;justify-content:space-between;gap:10px;font-size:12px;font-weight:650;color:#d9dfec;margin-bottom:6px}.hint{font-weight:400;color:#72809a}.two,.three{display:grid;gap:12px}.two{grid-template-columns:1fr 1fr}.three{grid-template-columns:repeat(3,1fr)}input,textarea,select{width:100%;border:1px solid #303b52;border-radius:11px;background:#0d121b;color:var(--text);padding:10px 11px;outline:none;transition:border-color .2s,box-shadow .2s}textarea{min-height:82px;resize:vertical}input:focus,textarea:focus,select:focus{border-color:var(--accent2);box-shadow:0 0 0 3px #79d7ff1a}.drop{border:1px dashed #60718f;border-radius:16px;padding:22px;background:#0c111a;transition:.2s}.drop:hover,.drop.active{border-color:var(--accent);background:#b9f36a0b}.drop input{border:0;padding:0;background:transparent}.file-name{color:var(--muted);font-size:12px;margin-top:8px;min-height:18px}.actions{display:flex;align-items:center;gap:12px;flex-wrap:wrap;margin-top:20px}.primary{border:0;border-radius:12px;padding:12px 18px;background:var(--accent);color:#11180d;font-weight:800;box-shadow:0 0 0 1px #fff2,0 8px 25px #b9f36a26}.primary:hover{filter:brightness(1.06);transform:translateY(-1px)}.secondary{border:1px solid #43516e;border-radius:12px;padding:11px 15px;background:#182033;color:#eaf0fb;font-weight:700}.status{color:var(--muted);font-size:13px}.status.error{color:var(--danger)}.status.ok{color:var(--accent)}.boundary{margin-top:18px;padding:15px;border-radius:15px;border:1px solid #6b5c31;background:#2a2416;color:#e6d6a8;font-size:13px}.boundary strong{display:block;color:#fff2bf;margin-bottom:4px}.result{display:none}.result.visible{display:block}.empty{border:1px dashed #354158;border-radius:14px;padding:18px;color:var(--muted);font-size:13px}.metrics{display:grid;grid-template-columns:repeat(4,1fr);gap:8px;margin:14px 0}.metric{padding:11px;border-radius:12px;background:#0c111a;border:1px solid #273149}.metric b{display:block;font-size:20px;color:var(--accent2)}.metric span{font-size:11px;color:var(--muted)}.scene{border:1px solid #33415d;background:#111824;border-radius:15px;padding:15px;margin-top:11px}.scene-head{display:flex;justify-content:space-between;gap:10px;color:#dce5f4;font-size:12px;margin-bottom:7px}.scene h4{font-size:15px;margin:0 0 8px;color:var(--accent)}.scene p{font-size:13px;color:#c7d0df;margin:5px 0}.scene .tag{display:inline-block;color:#9de4ff;font-size:11px;padding:2px 7px;border:1px solid #79d7ff55;border-radius:99px;margin-right:5px}.fine{font-size:12px;color:var(--muted)}.pill{display:inline-block;padding:4px 8px;border:1px solid #b9f36a55;border-radius:99px;color:var(--accent);font-size:11px}.check{display:flex;gap:8px;align-items:flex-start;font-size:12px;color:var(--muted)}.check input{width:auto;margin-top:4px}.footer{margin-top:26px;color:#66738a;font-size:12px;text-align:center}
  ...
  <main class="shell">
    ...
    <div class="grid">
      <form class="panel" id="studioForm">
        ...
        <div class="two"><div class="field"><label for="mode">Narrative mode</label><select id="mode"><option value="song">Song · lyrical arc</option><option value="spoken_word">Spoken word · argument and turn</option><option value="meditation">Meditation · guided descent and return</option><option value="cinematic_narration">Cinematic narration · scene progression</option></select></div><div class="field"><label for="ratio">Aspect ratio</label><select id="ratio"><option>16:9</option><option>9:16</option><option>1:1</option><option>4:5</option></select></div></div>
